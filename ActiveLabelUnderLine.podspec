#
#  Be sure to run `pod spec lint ActiveLabelUnderLine.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Hemanth.Alluri"
  # s.authors            = { "Hemanth.Alluri" => "email@address.com" }
   s.social_media_url   = "http://twitter.com/h_alluri"
  ...
  s.source       = { :git => "https://github.com/hemanthalluri/ActiveLabelUnderLine.git"}
